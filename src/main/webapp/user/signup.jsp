...
<div class="glass-card p-8 rounded-2xl w-full max-w-md z-10">
    <h1 class="text-4xl font-extrabold text-gray-800 text-center mb-6 animate-pulse">Sign Up for Wheels</h1>
    <%
    ...
    <p class="mt-5 text-center text-sm text-gray-600">
        Already have an account? <a href="${pageContext.request.contextPath}/auth" class="text-red-500 hover:underline font-medium">Login</a>
    </p>
</div>
